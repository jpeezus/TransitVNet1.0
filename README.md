...
# Deployment guide
The deployment guide can be found [here](https://github.com//Azure-Transit-VNet/blob/master/documentation/Azure_Transit_VNet0.1_Deployment_Guide.pdf)
